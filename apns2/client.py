...
class APNsClient(object):
    ...
    def send_notification(self, token_hex, notification, priority=NotificationPriority.Immediate, topic=None, expiration=None):
        ...
        json_payload = json.dumps(payload, cls=self.__json_encoder, ensure_ascii=False, separators=(',', ':')).encode('utf-8')
        ...
        with self.__connection.get_response(stream_id) as resp:
